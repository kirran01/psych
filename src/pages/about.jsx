...
const About = () => {
    return (
        <div className='pt-16 flex flex-col fade-in'>
            <p className='text-4xl m-5 my-10 mb-12 text-center'>About</p>
            {/* <div className='mb-5'><p className='text-4xl text-center'>...</p></div> */}
            <div className='p-3 py-6 flex flex-col justify-center lg:flex-row md:flex-row items-center'>
                <div className='m-5 mx-10'>
                    <p className='italic underline text-3xl'>Bio</p>
                </div>
                <div className='border-2 p-10 m-5 mx-10 w-80 shrink-0'>
            ...
            <div className='flex flex-col md:flex-row lg:flex-row justify-center items-center bg-slate-50 p-3 py-6 mb-10'>
            ...
            <div className='flex lg:flex-row md:flex-row p-3 items-center justify-center bg-slate-50'>
                <div className='mx-5'>
                <p className='italic underline text-3xl text-center m-5'>Experience</p>
                </div>
                <div className='border-2 p-10 w-80'>
