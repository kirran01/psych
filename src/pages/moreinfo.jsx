...
const Moreinfo = () => {
    return (
        <div className='pt-16 p-3'>
            <p className='text-3xl text-center m-2'>Frequently Asked Questions / Additional Info</p>
            <div className='m-2 p-3'>
                <p className='underline text-lg mb-3'>Who are good canditates for therapy?</p>
            ...
            <div className='m-2 p-3'>
                <p className='underline text-lg mb-3'>Are there different types of therapy/counseling?</p>
