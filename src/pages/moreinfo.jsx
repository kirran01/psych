        ...
        <div className='pt-14 fade-in'>
           <div className="w-full bg-cover bg-center h-60 bg-view">
            ...
            <div className='m-2 p-3 fade-in'>
                ...
                <p className='text-center' >I currently do not have an office space available. Online video call and telephone sessions are available 10-5 Monday, Thursday, and Friday.</p>
