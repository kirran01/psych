        ...
        <div className='pt-14 fade-in'>
           <div className="w-full bg-cover bg-center h-60 bg-view">
            ...
            <div className='m-2 p-3 py-10 fade-in bg-slate-50'>
                ...
                <p className='text-center'><span className='underline' >Video call & telephone sessions: </span>$200TTD per hour long session</p>
                <p className='text-center'><span className='underline' >In-person session at office location: </span>$200TTD per hour long session</p>
                <p className='text-center'><span className='underline' >In-house session(I travel to you): </span>Port of Spain: $250TTD / East $300TTD / South $350TTD</p>
            </div>
