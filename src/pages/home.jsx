...
const Home = () => {
    const [wCards, setWCards] = useState([{ id: 1, title: 'Cognitive Behavioral Therapy', description: 'Cognitive behavioural therapy (CBT) is a talking therapy that can help you change your life by focusing on changing the way you think.', URL: 'https://www.nhs.uk/mental-health/talking-therapies-medicine-treatments/talking-therapies-and-counselling/cognitive-behavioural-therapy-cbt/overview/#:~:text=Cognitive%20behavioural%20therapy%20(CBT)%20is,mental%20and%20physical%20health%20problems.', full: '' },
    { id: 2, title: 'Humanistic Therapy', description: 'The humanistic approach is about free will, self-discovery, and achieving your full potential as a human being', URL: 'https://www.bacp.co.uk/about-therapy/types-of-therapy/humanistic-therapy/#:~:text=The%20humanistic%20approach%20is%20about,with%20the%20world%20around%20you.', full: '' },
    { id: 4, title: 'Psychoanalysis', description: 'Psychoanalytic therapy helps clients gain insight into their unconscious conflicts to create change through insight and experience', URL: 'https://tavistockandportman.nhs.uk/care-and-treatment/treatments/psychoanalytic-psychotherapy/#:~:text=Psychoanalytic%20psychotherapy%20is%20a%20talking,may%20contribute%20to%20your%20problems.', full: '' }])
    return (
